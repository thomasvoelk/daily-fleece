...
class SessionPhotoApiTest {
    ...
    @Test
    void getSessionPhotoByKey_q2_returns_image_bytes() {
        String date = createSession();

        ResponseEntity<byte[]> response = http.get()
                .uri("/sessions/default/" + date + "/photos/q2")
                .retrieve()
                .toEntity(byte[].class);
    ...
    private String createSession() {
        ...
        Map<String, Object> responseBody = Objects.requireNonNull(http.post()
                ...
                .getBody());
        return Objects.requireNonNull((String) responseBody.get("date"));
    }
}
