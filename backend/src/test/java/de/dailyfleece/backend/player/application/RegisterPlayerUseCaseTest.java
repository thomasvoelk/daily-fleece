...
class RegisterPlayerUseCaseTest {
    ...
    void register_returns_player_with_given_display_name() {
        Player player = useCase.register(new CompanyId("comp-1"), new DisplayName("Thomas"));
    ...
    void register_same_company_id_returns_same_player_id() {
        Player first = useCase.register(new CompanyId("comp-1"), new DisplayName("Thomas"));
        Player second = useCase.register(new CompanyId("comp-1"), new DisplayName("Thomas"));
